...
type RateRequest struct {
	...
	Base        string `protobuf:"bytes,1,opt,name=Base,proto3" json:"Base,omitempty"`               // 1 is location of the message field
	Destination string `protobuf:"bytes,2,opt,name=Destination,proto3" json:"Destination,omitempty"` // so the number is ordering of the field
}
...
var file_currency_proto_rawDesc = []byte{
	...
	0x2e, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x21, 0x5a,
	0x1f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x75, 0x70, 0x61, 0x6c,
	0x63, 0x68, 0x6f, 0x77, 0x64, 0x68, 0x75, 0x72, 0x79, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73,
